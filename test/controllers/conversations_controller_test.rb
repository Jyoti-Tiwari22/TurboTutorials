...
class ConversationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conversation" do
    assert_difference("Conversation.count") do
      post conversations_url, params: { conversation: { content: @conversation.content, title: @conversation.title } }
    end
  ...
  test "should update conversation" do
    patch conversation_url(@conversation), params: { conversation: { content: @conversation.content, title: @conversation.title } }
